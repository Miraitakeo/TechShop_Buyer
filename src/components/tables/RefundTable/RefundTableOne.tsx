...
const roleData: Role[] = [
  ...
  },
  {
    ...
    permissions: ["Handle Refunds & Disputes"],
    status: "Active",
  },
];

const RefundTableOne = () => {
  ...
  const handleRefundDispute = (roleName: string) => {
    alert(`${roleName} is handling refunds & disputes.`);
  };
                  ...
                  <TableRow key={role.id}>
                    ...
                    <TableCell className="px-4 py-3 text-start">
                      ...
                      {role.roleName === "Customer Support" && (
                        <button onClick={() => handleRefundDispute(role.roleName)} className="ml-2 px-4 py-2 text-white bg-purple-500 rounded-md hover:bg-purple-600">Handle Refunds</button>
                      )}
                    </TableCell>
                  </TableRow>
                ))
